...
library(magrittr)
getwd()
setwd('/Users/jiangshali/Desktop/2019GBD论文/risk\ factor')
# 数据清洗 --------------------------------------------------------------------


risk1 <- read.csv("IHME-GBD_2019_DATA-ba330d58-1.csv",header = T) 
colnames(risk1)
...
risk2 <- read.csv("IHME-GBD_2019_DATA-ba330d58-1.csv",header = T) 
colnames(risk2)
...
colnames(t10)
t10 <- read.csv("IHME-GBD_2019_DATA-ba330d58-1.csv",header=T) 
...
t11 <- read.csv("IHME-GBD_2019_DATA-ba330d58-1.csv",header=T) 
...
t20 <- read.csv("IHME-GBD_2019_DATA-ba330d58-1.csv",header=T) 
...
t21 <- read.csv("IHME-GBD_2019_DATA-ba330d58-1.csv",header=T) 
